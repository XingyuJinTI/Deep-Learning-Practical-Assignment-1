...
class Optimiser(object):
    ...
    def __init__(self, model, error, learning_rule, cos_anneal, train_dataset,
    ...
    def train(self, num_epochs, stats_interval=5):
        ...
        # cosine annealing
        if self.cos_anneal == True:
#             cosine_scheduler = CosineAnnealingWithWarmRestarts(min_learning_rate=0.01*self.learning_rule.learning_rate, max_learning_rate=self.learning_rule.learning_rate,
...
#                                                            period_iteration_expansion_factor=1.0)
            ...
            with self.tqdm_progress(total=num_epochs) as progress_bar:
                ...
                for epoch in range(1, num_epochs + 1):
                    ...
                    # cosine annealing
                    cosine_scheduler.update_learning_rule(learning_rule=self.learning_rule, epoch_number=epoch-1)
